<script lang="ts">
    ...
    function search(e: any) {
        ...
        if (value) {
            const filteredPatients = doctors.filter((patient) => {
                return (
    ...
    let showAddDoctorModal: boolean = false;
</script>

<Modal bind:showModal={showAddDoctorModal} action="?/add" title="Add New Doctor">
        ...
        <div class="flex space-x-8">
            <div class="mb-4 w-1/2">
                ...
                >
                    ...
                    {#each data.specialities as speciality}
...
<header class="py-5 px-8 border-b border-gray-100 flex justify-between">
    ...
    <nav>
        <button
                ...
                on:click={() => (showAddDoctorModal = true)}
        >
            New
        </button>
    </nav>
                ...
                >
                    <th scope="row" class="">
                        ...
                        >
                            ...
                            <div class="pl-3">
                                <div class="text-base font-semibold">{doctor.firstname} {doctor.lastname}</div>
                                <div class="font-normal text-gray-500">{doctor.email}</div>
                            </div>
                        </div>
                    </th>
                    <td class="px-6 py-4 space-y-1 capitalize"> {doctor.speciality} </td>
                    <td class="px-6 py-4 space-y-1 capitalize"> {doctor.gender} </td>
                    <td class="px-6 py-4"> {doctor.age} </td>
                    <td class="px-6 py-4">

...
<section class="grid gap-6 md:grid-cols-2 p-8 lg:grid-cols-4">
	...
	<div class="bg-white px-8 py-5 shadow rounded-md">
		<div class="flex space-x-4">
			...
			<div class="flex flex-col">
				...
				<span class="text-xl font-bold">{data.patients.length}</span>
			</div>
		</div>
	...
	<div class="bg-white px-8 py-5 shadow rounded-md">
		<div class="flex space-x-4">
			...
			<div class="flex flex-col">
				<span class="text-sm text-gray-400">Total Doctos</span>
				<span class="text-xl font-bold">{data.doctors.length}</span>
			</div>
		</div>
	...
	<div class="bg-white px-8 py-5 shadow rounded-md">
		<div class="flex space-x-4">
			...
			<div class="flex flex-col">
				<span class="text-sm text-gray-400">Total Nurses</span>
				<span class="text-xl font-bold">{data.nurses.length}</span>
			</div>
		</div>

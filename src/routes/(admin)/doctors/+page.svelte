...
{#if data.doctor.length >= 1}
			...
			<tbody>
				{#each data.doctor as doctor, index}
					<tr class="hover:bg-gray-200">
						...
						<td class="py-2 px-4">
							<form action="/doctors?/delete" method="post" use:enhance>
	...
	{:else}
	<h2>Sorry, there are no doctors available.</h2>
{/if}
...
<Modal bind:showModal={show}>
	...
	<form action="/doctors?/add" use:enhance method="post" class="w-96">
		...
		<div class="mb-4">
			<label class="block text-gray-700 text-sm font-bold mb-2" for="doctorAge"> Doctor Age </label>
			<input
				class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
				id="doctorAge"
				type="number"
		...
		<div class="mb-6">
			<label class="block text-gray-700 text-sm font-bold mb-2" for="doctorGender">
				Doctor Gender
			</label>
			<select
				class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"

...
<header class="py-5 border-b border-gray-100 px-8">
	<h1 class="text-3xl mb-1">Appontments</h1>
		...
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
				<tr>
					...
					<th scope="col" class="px-6 py-3"> Schedule date </th>
			...
			<tbody>
				...
				>
					...
					<td class="px-6 py-4">
						<!-- Modal toggle -->
						<a
							href="/doctor/appointments/12"
							type="button"
							data-modal-target="editUserModal"
							data-modal-show="editUserModal"
							class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Attend</a
						>
					</td>
				</tr>
			</tbody>
